  ...
  return (
    <main className="min-h-screen bg-emerald-50 flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <h2 className="text-2xl font-semibold text-stone-800 mb-6">Something Went Wrong</h2>
        <p className="text-lg text-stone-600 mb-6">
          Oops! We encountered an unexpected error. Don't worry, we're on it!
        </p>
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-white/40 rounded-xl p-6 mb-8 shadow-sm">
          <p className="text-sm text-stone-600 leading-relaxed mb-4">
            ...
            If this error persists, please <a href="mailto:contact@max-your-points.com" className="text-blue-600 hover:text-blue-800 underline decoration-blue-600/30 hover:decoration-blue-800 transition-colors">contact us</a> and let me know.
          </p>
          {error.digest && (
