...
import { OutlinedGradientButton } from "@/components/ui/outlined-gradient-button"
              ...
              <div>
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full px-5 py-2.5 text-base font-medium font-['Inter'] rounded-lg text-stone-950 hover:text-orange-500 disabled:opacity-70 disabled:cursor-not-allowed bg-white border-2 border-transparent bg-clip-padding bg-origin-border"
                    style={{
                      backgroundImage: "linear-gradient(white, white), linear-gradient(to right, #2DD4BF, #EAB308, #EA580C)",
                      backgroundOrigin: "border-box",
                      backgroundClip: "padding-box, border-box",
