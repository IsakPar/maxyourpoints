...
const navigationItems: NavItem[] = [
  {
    ...
    href: "/blog/categories/airline-and-aviation",
    subItems: [
      { label: "Reviews", href: "/blog/categories/airline-and-aviation/reviews" },
      { label: "News", href: "/blog/categories/airline-and-aviation/news" },
      { label: "Deals", href: "/blog/categories/airline-and-aviation/deals" },
      { label: "Guides", href: "/blog/categories/airline-and-aviation/guides" }
    ]
  },
  {
    label: "Credit Cards & Points",
    href: "/blog/categories/credit-cards-and-points",
    subItems: [
      { label: "Reviews", href: "/blog/categories/credit-cards-and-points/reviews" },
      { label: "News", href: "/blog/categories/credit-cards-and-points/news" },
      { label: "Deals", href: "/blog/categories/credit-cards-and-points/deals" },
      { label: "Guides", href: "/blog/categories/credit-cards-and-points/guides" }
    ]
  },
  {
    label: "Travel Hacks & Deals",
    href: "/blog/categories/travel-hacks-and-deals",
    subItems: [
      { label: "News", href: "/blog/categories/travel-hacks-and-deals/news" },
      { label: "Deals", href: "/blog/categories/travel-hacks-and-deals/deals" },
      { label: "Guides", href: "/blog/categories/travel-hacks-and-deals/guides" }
    ]
  },
  {
    label: "Hotels & Trip Reports",
    href: "/blog/categories/hotels-and-trip-reports",
    subItems: [
      { label: "Reviews", href: "/blog/categories/hotels-and-trip-reports/reviews" },
      { label: "News", href: "/blog/categories/hotels-and-trip-reports/news" },
      { label: "Deals", href: "/blog/categories/hotels-and-trip-reports/deals" },
      { label: "Trip Reports", href: "/blog/categories/hotels-and-trip-reports/trip-reports" }
    ]
  }
]
...
const Dropdown: React.FC<DropdownProps> = ({ item, onClose }) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-emerald-50 rounded-lg shadow-lg py-2 z-50 border border-emerald-100"
      role="menu"
    ...
    >
      {item.subItems?.map((subItem, index) => (
        <Link
          key={index}
          href={item.href}
          className="block px-4 py-2 text-sm text-stone-950 hover:bg-emerald-100 hover:text-emerald-600 transition-colors"
          role="menuitem"
          onClick={onClose}
        >
          {subItem.label}
...
const NavDropdown: React.FC<NavDropdownProps> = ({ item }) => {
  ...
  return (
    ...
    >
      <Link
        href={item.href}
        className="flex items-center gap-1 text-stone-950 text-sm font-medium font-['Inter'] leading-normal hover:text-orange-500 transition-colors min-w-[170px] whitespace-normal"
    ...
    >
      ...
      >
        <div className="flex flex-col p-5 space-y-5">
          {navigationItems.map((item, index) => (
            <MobileAccordion key={index} title={item.label}>
