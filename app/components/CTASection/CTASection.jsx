...
const CTASection = ({
  ...
  onSubscribe = null,
  redirectUrl = null,
  design = "gradient-teal", // 'gradient-teal', 'gradient-orange', 'pattern-dots', 'pattern-lines', 'overlay-teal'
}) => {
  ...
  const CustomButton = ({ href, children, type, disabled }) => {
    const style = {
    ...
    const buttonContent = (
      <button
        type={type}
        disabled={disabled}
        className="px-5 py-2.5 text-base font-medium font-['Inter'] rounded-lg shadow-md text-white disabled:opacity-70 disabled:cursor-not-allowed"
        style={style}
        onMouseOver={(e) => {
...
CTASection.propTypes = {
  ...
  withSubscribeForm: PropTypes.bool,
  onSubscribe: PropTypes.func,
  redirectUrl: PropTypes.string,
  design: PropTypes.oneOf(["gradient-teal", "gradient-orange", "pattern-dots", "pattern-lines", "overlay-teal"]),
}
