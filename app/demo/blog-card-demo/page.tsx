      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-8 flex justify-center">
            <button className="px-4 py-2 border-2 border-stone-950 rounded-lg text-stone-950 hover:bg-stone-950 hover:text-white transition-colors">View all articles</button>
          </div>
        </div>
      </div>
    </div>
