-- Update Newsletter Templates with New HTML Designs
...
<html>
  ...
  type = 'welcome'
WHERE name = 'Subscription Confirmation' OR type = 'welcome';
...
<body>
  ...
  type = 'custom'
WHERE name = 'Unsubscribe Confirmation';
...
<body>
  ...
  type = 'weekly'
WHERE name = 'Weekly Newsletter Template' OR type = 'weekly';

-- Update Airfare Deal Template
UPDATE newsletter_templates 
SET 
...
<body>
  ...
  type = 'airfare_daily'
WHERE name = 'Airfare Deal of the Day' OR type = 'airfare_daily';

-- Insert templates if they don't exist
INSERT INTO newsletter_templates (name, subject, content, html_content, type)
SELECT 'Subscription Confirmation', 'Welcome to Max Your Points! ✈️', 'Welcome to our community!', 
...
INSERT INTO newsletter_templates (name, subject, content, html_content, type)
SELECT 'Unsubscribe Confirmation', 'Sorry to see you go! 😢', 'You have been unsubscribed.', 
'<!DOCTYPE html><html><head><meta charset="utf-8"><title>Goodbye!</title></head><body>Unsubscribe message here</body></html>', 'custom'
WHERE NOT EXISTS (SELECT 1 FROM newsletter_templates WHERE name = 'Unsubscribe Confirmation');
